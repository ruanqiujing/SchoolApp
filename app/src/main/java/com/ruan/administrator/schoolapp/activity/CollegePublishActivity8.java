...
public class CollegePublishActivity8 extends AppCompatActivity {
    ...
    public void publish(View view){
        ...
        CollegePub8 lp = new CollegePub8();
        lp.setACL(acl);
        //保存当前用户的id
        ...
        lp.save(this, new SaveListener() {
            ...
            public void onSuccess() {
                Toast.makeText(CollegePublishActivity8.this,"发布成功",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(CollegePublishActivity8.this,CollegeActivity8.class));
                finish();
            }

            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(CollegePublishActivity8.this,"发布失败:"+s,Toast.LENGTH_SHORT).show();
                return;
            }
        });
    }
