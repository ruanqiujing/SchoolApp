...
public class ShowDetailLectureActivity6 extends AppCompatActivity {
    ...
    private void initView() {
        ...
        iv_show_content.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivityForResult(new Intent(ShowDetailLectureActivity6.this, CollegeActivity6.class), 0);
                finish();
            }
        });
        //删除活动
        iv_community_show_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CollegePub6 pub = new CollegePub6();
                pub.setObjectId(objectId);
                pub.delete(ShowDetailLectureActivity6.this, new DeleteListener() {
                    @Override
                    public void onSuccess() {
                        Toast.makeText(ShowDetailLectureActivity6.this,"删除成功",Toast.LENGTH_SHORT).show();
                        startActivityForResult(new Intent(ShowDetailLectureActivity6.this, CollegeActivity6.class), 0);
                        finish();
                    }
                    ...
                    public void onFailure(int i, String s) {
                        Toast.makeText(ShowDetailLectureActivity6.this,"删除失败:"+s,Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == CollegeActivity6.RESULT_CODE) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            startActivity(new Intent(ShowDetailLectureActivity6.this, CollegeActivity6.class));
            finish();
            return true;
        }
