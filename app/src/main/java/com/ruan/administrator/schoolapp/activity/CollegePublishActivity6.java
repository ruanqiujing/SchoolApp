...
public class CollegePublishActivity6 extends AppCompatActivity {
    ...
    public void publish(View view){
        ...
        CollegePub6 lp = new CollegePub6();
        lp.setACL(acl);
        //保存当前用户的id
        ...
        lp.save(this, new SaveListener() {
            ...
            public void onSuccess() {
                Toast.makeText(CollegePublishActivity6.this,"发布成功",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(CollegePublishActivity6.this,CollegeActivity6.class));
                finish();
            }

            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(CollegePublishActivity6.this,"发布失败:"+s,Toast.LENGTH_SHORT).show();
                return;
            }
        });
    }
