...
public class ShowDetailLectureActivity1 extends AppCompatActivity {
    ...
    private void initView() {
        ...
        iv_show_content.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivityForResult(new Intent(ShowDetailLectureActivity1.this, CollegeActivity1.class), 0);
                finish();
            }
        });
        //删除活动
        iv_community_show_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CollegePub1 pub = new CollegePub1();
                pub.setObjectId(objectId);
                pub.delete(ShowDetailLectureActivity1.this, new DeleteListener() {
                    @Override
                    public void onSuccess() {
                        Toast.makeText(ShowDetailLectureActivity1.this,"删除成功",Toast.LENGTH_SHORT).show();
                        startActivityForResult(new Intent(ShowDetailLectureActivity1.this, CollegeActivity1.class), 0);
                        finish();
                    }
                    ...
                    public void onFailure(int i, String s) {
                        Toast.makeText(ShowDetailLectureActivity1.this,"删除失败:"+s,Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == CollegeActivity1.RESULT_CODE) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            startActivity(new Intent(ShowDetailLectureActivity1.this, CollegeActivity1.class));
            finish();
            return true;
        }
