...
public class CollegePublishActivity7 extends AppCompatActivity {
    ...
    public void publish(View view){
        ...
        CollegePub7 lp = new CollegePub7();
        lp.setACL(acl);
        //保存当前用户的id
        ...
        lp.save(this, new SaveListener() {
            ...
            public void onSuccess() {
                Toast.makeText(CollegePublishActivity7.this,"发布成功",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(CollegePublishActivity7.this,CollegeActivity7.class));
                finish();
            }

            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(CollegePublishActivity7.this,"发布失败:"+s,Toast.LENGTH_SHORT).show();
                return;
            }
        });
    }
