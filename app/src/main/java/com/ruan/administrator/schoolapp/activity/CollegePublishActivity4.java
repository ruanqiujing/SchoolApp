...
public class CollegePublishActivity4 extends AppCompatActivity {
    ...
    public void publish(View view){
        ...
        CollegePub4 lp = new CollegePub4();
        lp.setACL(acl);
        //保存当前用户的id
        ...
        lp.save(this, new SaveListener() {
            ...
            public void onSuccess() {
                Toast.makeText(CollegePublishActivity4.this,"发布成功",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(CollegePublishActivity4.this,CollegeActivity4.class));
                finish();
            }

            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(CollegePublishActivity4.this,"发布失败:"+s,Toast.LENGTH_SHORT).show();
                return;
            }
        });
    }
