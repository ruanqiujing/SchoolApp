...
public class CollegePublishActivity3 extends AppCompatActivity {
    ...
    public void publish(View view){
        ...
        CollegePub3 lp = new CollegePub3();
        lp.setACL(acl);
        //保存当前用户的id
        ...
        lp.save(this, new SaveListener() {
            ...
            public void onSuccess() {
                Toast.makeText(CollegePublishActivity3.this,"发布成功",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(CollegePublishActivity3.this,CollegeActivity3.class));
                finish();
            }

            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(CollegePublishActivity3.this,"发布失败:"+s,Toast.LENGTH_SHORT).show();
                return;
            }
        });
    }
