...
public class CollegePublishActivity0 extends AppCompatActivity {
    ...
    public void publish(View view){
        ...
        CollegePub0 lp = new CollegePub0();
        lp.setACL(acl);
        //保存当前用户的id
        ...
        lp.save(this, new SaveListener() {
            ...
            public void onSuccess() {
                Toast.makeText(CollegePublishActivity0.this,"发布成功",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(CollegePublishActivity0.this,CollegeActivity0.class));
                finish();
            }

            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(CollegePublishActivity0.this,"发布失败:"+s,Toast.LENGTH_SHORT).show();
                return;
            }
        });
    }
