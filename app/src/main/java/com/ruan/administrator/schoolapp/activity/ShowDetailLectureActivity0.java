...
public class ShowDetailLectureActivity0 extends AppCompatActivity {
    ...
    private void initView() {
        ...
        iv_show_content.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivityForResult(new Intent(ShowDetailLectureActivity0.this, CollegeActivity0.class), 0);
                finish();
            }
        });
        //删除活动
        iv_community_show_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CollegePub0 pub = new CollegePub0();
                pub.setObjectId(objectId);
                pub.delete(ShowDetailLectureActivity0.this, new DeleteListener() {
                    @Override
                    public void onSuccess() {
                        Toast.makeText(ShowDetailLectureActivity0.this,"删除成功",Toast.LENGTH_SHORT).show();
                        startActivityForResult(new Intent(ShowDetailLectureActivity0.this, CollegeActivity0.class), 0);
                        finish();
                    }
                    ...
                    public void onFailure(int i, String s) {
                        Toast.makeText(ShowDetailLectureActivity0.this,"删除失败:"+s,Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == CollegeActivity0.RESULT_CODE) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            startActivity(new Intent(ShowDetailLectureActivity0.this, CollegeActivity0.class));
            finish();
            return true;
        }
