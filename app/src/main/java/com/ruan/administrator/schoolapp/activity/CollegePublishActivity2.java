...
public class CollegePublishActivity2 extends AppCompatActivity {
    ...
    public void publish(View view){
        ...
        CollegePub2 lp = new CollegePub2();
        lp.setACL(acl);
        //保存当前用户的id
        ...
        lp.save(this, new SaveListener() {
            ...
            public void onSuccess() {
                Toast.makeText(CollegePublishActivity2.this,"发布成功",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(CollegePublishActivity2.this,CollegeActivity2.class));
                finish();
            }

            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(CollegePublishActivity2.this,"发布失败:"+s,Toast.LENGTH_SHORT).show();
                return;
            }
        });
    }
