...
public class CollegePublishActivity1 extends AppCompatActivity {
    ...
    public void publish(View view){
        ...
        CollegePub1 lp = new CollegePub1();
        lp.setACL(acl);
        //保存当前用户的id
        ...
        lp.save(this, new SaveListener() {
            ...
            public void onSuccess() {
                Toast.makeText(CollegePublishActivity1.this,"发布成功",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(CollegePublishActivity1.this,CollegeActivity1.class));
                finish();
            }

            @Override
            public void onFailure(int i, String s) {
                Toast.makeText(CollegePublishActivity1.this,"发布失败:"+s,Toast.LENGTH_SHORT).show();
                return;
            }
        });
    }
